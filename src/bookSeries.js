            ...
            var result = {
                ...
                parse: function (pageContent) {
                    ...
                    allBooks.replace(booksRe, function (match, link, title, size, genre1, genre2, n, n2, n3, n4, annotation ) {
                        ...
                        var book = Book.Book(link, false);
                        book.info({
                            title: title,
                            size: size,
                            genres: _.trim(genre).split(',').map(function(elem){return _.trim(elem);}),
